<div
    class="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto mt-10 text-gray-900 bg-gray-100 rounded-lg shadow-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
    <div class="flex flex-col justify-between">
        <div>
            <h2 class="text-4xl font-bold leading-tight lg:text-5xl">Vamos conversar!</h2>
            <div class="mt-8 text-gray-700">
                Prefere E-mail? Basta me enviar então <span class="underline">andson.alex@yahoo.com</span>
            </div>
        </div>
        <div class="mt-8 text-center">
            <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <g opacity="0.1">
                    <ellipse cx="479.42" cy="362.12" rx="11.38" ry="14.9" fill="#294B54" />
                    <path
                        ...
                        transform="translate(-52 -162.63)" fill="#294B54" />
                    <ellipse cx="479.42" cy="271.07" rx="11.38" ry="14.9" fill="#294B54" />
                    <ellipse cx="479.42" cy="252.86" rx="11.38" ry="14.9" fill="#294B54" />
                    <path
                ...
                <g opacity="0.1">
                    <ellipse cx="612.28" cy="330.26" rx="8.51" ry="11.13" fill="#294B54" />
                    <path
                        ...
                        transform="translate(-52 -162.63)" fill="#294B54" />
                    <ellipse cx="612.28" cy="262.22" rx="8.51" ry="11.13" fill="#294B54" />
                    <ellipse cx="612.28" cy="248.61" rx="8.51" ry="11.13" fill="#294B54" />
                    <path
                ...
                <g opacity="0.1">
                    <ellipse cx="1038.58" cy="322.12" rx="11.38" ry="14.9" fill="#294B54" />
                    <path
                        ...
                        transform="translate(-52 -162.63)" fill="#294B54" />
                    <ellipse cx="1038.58" cy="231.07" rx="11.38" ry="14.9" fill="#294B54" />
                    <ellipse cx="1038.58" cy="212.86" rx="11.38" ry="14.9" fill="#294B54" />
                    <path
                ...
                <g opacity="0.1">
                    ...
                    <path
                        ...
                        transform="translate(-52 -162.63)" fill="#294B54" />
                    <ellipse cx="928.72" cy="256.22" rx="8.51" ry="11.13" fill="#294B54" />
                    <ellipse cx="928.72" cy="242.61" rx="8.51" ry="11.13" fill="#294B54" />
                    <path
                ...
                <g opacity="0.1">
                    <ellipse cx="61.59" cy="322.12" rx="11.38" ry="14.9" fill="#294B54" />
                    <path
                        ...
                        transform="translate(-52 -162.63)" fill="#294B54" />
                    <ellipse cx="61.59" cy="231.07" rx="11.38" ry="14.9" fill="#294B54" />
                    <ellipse cx="61.59" cy="212.86" rx="11.38" ry="14.9" fill="#294B54" />
                    <path
                ...
                <g opacity="0.1">
                    <ellipse cx="171.44" cy="324.26" rx="8.51" ry="11.13" fill="#294B54" />
                    <path
                        ...
                        transform="translate(-52 -162.63)" fill="#294B54" />
                    <ellipse cx="171.44" cy="256.22" rx="8.51" ry="11.13" fill="#294B54" />
                    <ellipse cx="171.44" cy="242.61" rx="8.51" ry="11.13" fill="#294B54" />
                    <path
                ...
                <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#10B981" opacity="0.1" />
                <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#10B981" opacity="0.1" />
                <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#10B981" opacity="0.1" />
                <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#10B981" opacity="0.1" />
                <path
                    ...
                    transform="translate(-52 -162.63)" fill="#10B981" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-52 -162.63)" fill="none" stroke="#294B54" stroke-miterlimit="10"
                    stroke-width="4" />
                ...
                <path
                    ...
                    transform="translate(-52 -162.63)" opacity="0.1" />
                <circle cx="779.73" cy="238.18" r="99.96" fill="#294B54" />
                <path
                ...
                <path
                    ...
                    transform="translate(-52 -162.63)" opacity="0.1" />
                <circle cx="550.08" cy="390.01" r="99.96" fill="#294B54" />
                <path
                ...
                <path
                    ...
                    transform="translate(-52 -162.63)" opacity="0.1" />
                <circle cx="312.85" cy="315.36" r="99.96" fill="#294B54" />
    ...
    <div class="">
        <div>
            <span class="text-sm font-bold text-green-600 uppercase">Nome</span>
            <input class="w-full p-3 mt-2 text-green-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"
                type="text" placeholder="">
        </div>
        <div class="mt-8">
            <span class="text-sm font-bold text-green-600 uppercase">E-mail</span>
            <input class="w-full p-3 mt-2 text-green-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"
                type="text">
        </div>
        <div class="mt-8">
            <span class="text-sm font-bold text-green-600 uppercase">Mensagem</span>
            <textarea
                class="w-full h-32 p-3 mt-2 text-green-900 bg-gray-300 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
        </div>
        <div class="mt-8">
            <button
                class="w-full p-3 text-sm font-bold tracking-wide text-green-100 uppercase bg-green-500 rounded-lg focus:outline-none focus:shadow-outline">
                Enviar
            </button>
        </div>
    </div>
