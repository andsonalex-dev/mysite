   <div class="fixed inset-0 z-10 overflow-y-auto ease-out duration-400">
       <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center lg:block lg:p-0 ">
           <div class="fixed inset-0 transition-opacity">
               <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
           </div>
           <!-- This element is to trick the browser into centering the modal contents. -->
           <span class="hidden lg:inline-block lg:align-middle lg:h-screen"></span>
           <div class="inline-block w-full mt-10 mb-10 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl max-w-7xl "
               role="dialog" aria-modal="true" aria-labelledby="modal-headline">
               <div class="lg:grid lg:grid-cols-2 lg:gap-6">
                   <div class="md:col-span-1">
                       <div class="px-4 mt-5 ml-3 sm:px-0">
                           <h3 class="text-lg font-medium leading-6 text-gray-900">Novo Projeto</h3>
                           <p class="mt-1 text-sm text-gray-600">
                               Espaço para criar um novo projeto, site, ou sistema web.
                           </p>
                       </div>
                       @if (session()->has('message'))
                           <div class="flex items-center px-4 py-3 ml-5 text-sm font-bold text-white bg-blue-500"
                               role="alert">
                                   ...
                                   <div class="grid grid-cols-3 gap-6">
                                       <div class="col-span-3 sm:col-span-2">
                                           ...
                                           <div class="flex mt-1 rounded-md shadow-sm">
                                               ...
                                               <input type="text" wire:model="url" id="company_website"
